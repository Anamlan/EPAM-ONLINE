...
<xsl:stylesheet version="1.0"
                xmlns:bank="http://www.bank-app.com"
                xmlns:xslt="http://xml.apache.org/xslt"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xsi:schemaLocation="http://www.bank-app.com">
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="bank:account">
                        <tr>
                            ...
                            <td>
                                <xsl:value-of select="bank:depositor"/>
                            </td>
                            <td>
                                <xsl:value-of select="bank:country"/>
                            </td>
                            <td>
                                <table border="1">
                                    <tr bgcolor="#9acd32">
                                    ...
                                    <xsl:for-each select="bank:valet">
                                        <tr>
                                            <td>
                                                <xsl:value-of select="bank:type"/>
                                            </td>
                                            <td>
                                                <xsl:value-of select="bank:amount"/>
                                            </td>
                                            <td>
                                                <xsl:value-of select="bank:currency"/>
                                            </td>
                                            <td>
                                                <xsl:value-of select="bank:annualPercentage"/>
                                            </td>
                                            <td>
                                                <xsl:value-of select="bank:depositTerm"/>
                                            </td>
                                        </tr>
                                    </xsl:for-each>
                                </table>
